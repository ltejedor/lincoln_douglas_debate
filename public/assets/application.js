...
(function() {
  jQuery(function() {
    ...
    $('form').on('click', '.round-row', function() {
      if ($(this).next().children().first().next().children('.select').children().children().val() !== "") {
        return $(this).next().children('td').last().removeClass('hide-this');
      }
    });
    return $('form').on('change', '.round-kind', function() {
      if ($(this).val() !== "") {
        $(this).parent().parent().parent().parent().children('.new-bracket-link').removeClass('hide-this');
      }
      if ($(this).val() === "") {
        $(this).parent().parent().parent().parent().children('.new-bracket-link').addClass('hide-this');
      }
      if ($(this).val() === "") {
        return $(this).parent().parent().parent().parent().children('td').children('fieldset').hide();
      }
    });
  });
...
# Set tournament picture height equal to width
;
(function() {
