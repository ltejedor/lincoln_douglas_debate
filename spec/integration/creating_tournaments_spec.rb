...
feature 'Creating Tournaments' do
  ...
  scenario 'can create a tournament' do
    ...
    fill_in 'Description', :with => "Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur"
    click_button "Create Tournament"
    page.should have_content('Tournament was successfully created')
  end

  scenario "cannot create a tournament without a name and description" do
    click_button 'Create Tournament'
    page.should have_content("Name can't be blank")
    page.should have_content("Description can't be blank")
  end
  
  scenario "cannot have a description longer than 500 characters" do
    ...
    click_button "Create Tournament"
    page.should have_content("Description should be less than 500 characters")
